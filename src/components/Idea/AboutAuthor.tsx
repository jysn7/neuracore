...
const AboutAuthor: React.FC<AuthorProps> = ({ name, initials, role, bio, accountType }) => {
  return (
    <div className="w-full md:w-[80%] flex flex-col px-3 my-6 md:my-8 rounded-lg py-4 bg-bg-dark border border-border-secondary">
      <h1 className="text-lg pl-4 mb-4 md:mb-6 font-semibold text-text-primary">About the Author</h1>
      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-4">
        ...
        <div className="flex-shrink-0 flex justify-center sm:justify-start">
          <div className="bg-btn-secondary-hover h-10 w-10 md:h-12 md:w-12 flex items-center justify-center rounded-full">
            <p className="text-[9px] md:text-[10px] text-white font-semibold">{initials}</p>
          </div>
        </div>
        ...
        <div className="flex-1 px-2 sm:px-4">
          ...
          <p className="text-xs text-btn-secondary-hover mb-1 font-semibold">{accountType}</p>
